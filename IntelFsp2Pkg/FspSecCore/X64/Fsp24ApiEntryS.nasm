...
NotMultiPhaseSiInitApi:
  ...
  ;  Get Stackbase and StackSize from FSPS_UPD Param
  mov    rdx, rcx                                ; Put FSPS_UPD Param to rdx
  cmp    rdx, 0
  jnz    FspStackSetup
...
FspStackSetup:
  mov    cl, [rdx + FSPS_UPD_COMMON_FSP24.Revision]
  cmp    cl, 3
  jae    FspsUpdCommonFsp24
...
FspsUpdCommonFsp24:
  ...
  ;
  mov    rdi, [rdx + FSPS_UPD_COMMON_FSP24.StackBase]
  mov    ecx, [rdx + FSPS_UPD_COMMON_FSP24.StackSize]
